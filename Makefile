...
repeats.a: ${libSources} ${libHeaders} hal/lib/halLib.a sonLib/lib/sonLib.a ${basicLibsDependencies}
	rm -f *.o
	${cpp} ${cppflags} -I src -I poaV2/ -I hal/lib -I sonLib/lib -c ${libSources} poaV2/liblpo.a -fopenmp
	ar rc repeats.a *.o
	ranlib repeats.a
	rm *.o

cactusRepeatAnnotator : src/main.cpp repeats.a hal/lib/halLib.a
	${cpp} ${cppflags} -I src -I src -I hal/lib -I sonLib/lib -I src -I tests -o cactusRepeatAnnotator src/main.cpp repeats.a sonLib/lib/sonLib.a hal/lib/halLib.a poaV2/liblpo.a ${basicLibs} -fopenmp
