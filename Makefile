...
bin/annotationConcordance: impl/annotationConcordance.c ${libSonLib}
	${cc} ${cflags} -o bin/annotationConcordance -I ${sonLibInc} impl/annotationConcordance.c ${libSonLib} -lm
